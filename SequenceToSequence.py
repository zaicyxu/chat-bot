...
class Seq2Seq(object):
    ...
    def build_decoder_cell(self, encoder_outputs, encoder_final_state,
        ...
        cell = AttentionWrapper(
            ...
            attention_layer_size=self.hidden_size,  # 用来控制最后生成的attention由来;如果不是None，则在调用_compute_attention方法时，得到的加权和向量还会与output进行concat，然后再经过一个线性映射，变成维度为attention_layer_size的向量
